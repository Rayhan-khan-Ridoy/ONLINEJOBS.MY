                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <p class="mb-0" style="display: flex; align-items: center;">
                                        <i class="material-icons" style="font-size: 28px; color: red; margin-right: 8px;">place</i>
                                        {{ $jobs_details->city_name ?? 'N/A' }},
                                        {{ $jobs_details->state_name ?? 'N/A' }}
                                    </p>
                                    
                                    @auth
                                        <p class="my-0 text-secondary">{{$jobs_details->salary_offer_currency }} {{$job->salary_offer}}</p>
                                    @else
                                    <p class="my-0">
                                        <a href="/login" style="color: #E05024; text-decoration: none; display: flex; align-items: center;">
                                            <i class="material-icons" style="font-size: 32px; color: red; margin-right: 8px;">link</i>
