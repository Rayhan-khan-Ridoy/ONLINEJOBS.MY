...
<main id="main">
        ...
        <section id="about-us" class="about-us">
            <div class="container" data-aos="fade-up">
                ...
                <div class="col-lg-9" >
                    <h3>FOREIGN WORKERS MANAGEMENT PLATFORM </h3>
                    <ul>
                        <li>
                            We provide access to the Foreign Workers Management Platform for employers to manage the workers data, workers passport and work permit expiry information.
                        </li>
                        
                        <li>
                            We provide  counselling to employees.
                        </li>
                        <li>
                            We provide assistance required to liaise with issues pertaining to Immirgation / police cases.
                        </li>
                    </ul>
                </div>
                <?php /*
