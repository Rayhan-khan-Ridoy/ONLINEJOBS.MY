...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('site/img/favicon.png')}}" rel="icon" rel="shortcut icon" type="image/x-icon">
...
<body>
  ...
  <header id="header" class="fixed-top" >
    <div class="container d-flex align-items-center" >
      ...
      <a href="/"> <img src="{{asset('site/img/onlinelogo.png')}}" style="width: 120px"></a>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="/job">View Jobs Offers</li>
        </ul>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h4>ABOUT</h4>
            <p>We aspire to be the world’s leading online recruitment platform with an element of welfare protection for job seekers and employer.</p>
             <p>We provide online CV of local and foreign workers to cater for the local and global demand.</p>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li> <i class="bx bx-chevron-right"></i> <a href="/fwwmc">Who We Are</a></li>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <ul>
              <li class="bi bi-geo-alt"><div style="margin-left:20px; margin-top:-22px;"> Unit C-3A-11, Centum @ Oasis Corporate Park No. 2,
Jalan PJU 1A/2, Ara Damansara, 47301 Petaling Jaya,
Selangor Darul Ehsan,
Malaysia</div></li>
              <li class="bi bi-phone"> <div style="margin-left:20px; margin-top:-22px;"> <a href="Tel:+60376623791">+603 7662 3791</a><?php /*, <a href="Tel:+60380805249">+603 80805249</a> */?></div></li>
              <li class="bi bi-envelope"> <div style="margin-left:20px; margin-top:-22px;"> <a href="mailto:enquiry@onlinejobs.my">enquiry@onlinejobs.my</a>
              <?php /*, <a href="mailto:marketing@oninejobs.my">marketing@oninejobs.my</a> */ ?></div></li>
            </ul>
          </div>
