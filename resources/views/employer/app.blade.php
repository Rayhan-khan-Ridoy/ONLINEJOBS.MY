            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    @auth
                        @if(Auth::user()->status == 1)
                            ...
                            @if (auth()->user()->roles->first()->name == 'professional')
                                <li class="nav-item">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <h6 class="text-info font-weight-bold">Welcome, Mr/Ms. {{Auth::user()->name}}</h6>
                            <h8 class="text-danger">Logged in as {{ Auth::user()->roles->first()->name ?? 'No role' }}
                            </h8>
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="{{route('employer.public', Auth::user()->public_id)}}">View
                                Information</a>
                            <a class="dropdown-item" href="{{route('employer.edit', Auth::user()->id)}}">Edit
                                Information</a>
                            @endif
            ...
            <div class="row">
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <p>We want to be the world’s leading specialist online recruitment consultancy and Welfare
                            protection provider for Jobseeks and Employer. We provide online CV on local and foreign
                            workers to carter local and global demand</p>
                        <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-3">
                            <li class="ftco-animate"><a href="https://twitter.com/"><span
                                        class="icon-twitter"></span></a></li>
                            <li class="ftco-animate"><a
                                    href="https://www.facebook.com/Ap-online-jobs-109054537309212"><span
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4 ml-md-4">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="{{route('mission.vision')}}" class="py-2 d-block">Mission, Values and
                                    Purpose</a></li>
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon icon-map-marker"></span><span class="text">Puchong,
                                        Malaysia</span></li>
                                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+60
                                            162104126</span></a></li>
                                <li><a href="#"><span class="icon icon-envelope"></span><span
                                            class="text">info@onlinejobs.my</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
