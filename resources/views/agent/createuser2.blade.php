...
@endif --}}
                            ...
                            @else
                                <div class="col-md-6">
                                    <div class="form-group dis-cls">
                                        <div class="row">
                                            <div class="col-md-2">
                                                <input id="role" class="radio" type="radio" name="role"
                                                    value="worker" required>
                                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input id="date_of_birth" type="date"
                                        ...
                                        name="date_of_birth" min="1900-01-01" max="2200-01-01"
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <small id="phoneError" style="visibility:hidden;color:red">Contact Number is
                                        mandatory</small>
                                    <!-- @if ($errors->has('phone'))
    <span class="invalid-feedback" role="alert">
                                    ...
                                    <select name="gender" id="gender"
                                        ...
                                        @foreach ($genders as $gender)
                                            <option value="{{ $gender->id }}"
                                                {{ $gender->id == old('gender') ? 'selected' : '' }}>{{ $gender->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    <small id="genderError" style="visibility:hidden;color:red">Gender is
                                        mandatory</small>
    ...
    @endif -->
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <select onChange="displayChildren(this.value)" name="marital_status"
                                        id="marital_status"
                                        class="form-control{{ $errors->has('marital_status') ? ' is-invalid' : '' }}">
                                        <option value="">-- Select Marital Status --</option>
                                        @foreach ($marital_statuses as $marital_status)
                                            <option value="{{ $marital_status->id }}"
                                                {{ $marital_status->id == old('marital_status') ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <input id="children" type="children"
                                        class="form-control{{ $errors->has('children') ? ' is-invalid' : '' }}"
                                        name="children" value="{{ old('children') }}" placeholder="Children">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input id="siblings" type="siblings"
                                        class="form-control{{ $errors->has('siblings') ? ' is-invalid' : '' }}"
                                        name="siblings" value="{{ old('siblings') }}" placeholder="Siblings">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <small id="addressError" style="visibility:hidden;color:red">Address is
                                        mandatory</small>
    ...
    @endif
                            ...
                            <div class="form-group row">
                                        ...
                                        @if (Auth::user()->hasRole('superadministrator|agent|part-timer') && Auth::user()->status == 1)
                                            ...
                                            @foreach ($nationalitys as $nationality)
                                                <option value="{{ $nationality->id }}"
                                                    {{ $nationality->id == old('nationality') ? 'selected' : '' }}>
                                                    {{ $nationality->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    <small id="nationalityError" style="visibility:hidden;color:red">Nationality is
                                        mandatory</small>
                                    ...
                                    <select name="religion" id="religion"
                                        ...
                                        @foreach ($religions as $religion)
                                            <option value="{{ $religion->id }}"
                                                {{ $religion->id == old('religion') ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input id="height" type="text"
                                        ...
                                        name="height" value="{{ old('height') }}" placeholder="Height">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <input id="father_contact_number" type="text"
                                        class="form-control{{ $errors->has('father_contact_number') ? ' is-invalid' : '' }}"
                                ...
                                @if (request()->t == 'gw')
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select name="sub_sector" id="sub_sector"
                                            class="form-control{{ $errors->has('sub_sector') ? ' is-invalid' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group dis-cls1">
                                            <div class="upload-label">
                                                <label for="image">{{ __('Half Image') }}</label><span
                                                ...
                                                <div class="upload-area">
                                                    ...
                                                    <span class="uploadfiles">
                                                        <input id="image"
                                                            onchange="previewFile('#image_preview', '#image')"
                                                            type="file"
                                                            class="form-control-file{{ $errors->has('image') ? ' is-invalid' : '' }}"
                                                            name="image" value="{{ old('image') }}" accept=".jpg,.jpeg,.png">
                                                    </span>
                                                    <p class="text-short-mes">Supported file format JPG, PNG. Maximum file
                                                        size: 1MB</p>
                                                    <img id="image_preview" style="width: 100px;" src=""
                                                        class="img-thumbnail" height="">
                                                    <small id="imageError" style="visibility:hidden;color:red">Half Image
                                                        is mandatory</small>
                                            ...
                                            <div class="upload-label">
                                                ...
                                                <div class="upload-area">
                                                    <button type="button" class="upload-btn"><span
                                                            ng-bind="uploader.status.fileName">Upload Photo</span></button>
                                                    <span class="uploadfiles">
                                                        <input onchange="previewFile('#full_image_preview','#full_image')"
                                                            id="full_image" type="file"
                                                            class="form-control-file{{ $errors->has('full_image') ? ' is-invalid' : '' }}"
                                                            name="full_image">
                                                    </span>
                                                    <p class="text-short-mes">Supported file format JPG, PNG. Maximum file
                                                        size: 1MB</p>
                            ...
                            <div class="col-md-12 pt-5 page-section" id="Emergency-Contact">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <label for="emergency_contact_name">{{ __('Name ') }}<span
                                                class="text-danger">*</span></label>
                                        <input id="emergency_contact_name" type="text"
                                            class="form-control{{ $errors->has('emergency_contact_name') ? ' is-invalid' : '' }}"
                                            name="emergency_contact_name" value="{{ old('emergency_contact_name') }}"
                                            placeholder="Name" required>
                                        <small id="emergency_contact_nameError"
                                            style="visibility:hidden;color:red">Emergency Contact Name is mandatory</small>
                                    ...
                                    <div class="col-sm-3">
                                        <label for="emergency_contact_relationship">{{ __('Relationship ') }}<span
                                                class="text-danger">*</span></label>
                                        <input id="emergency_contact_relationship" type="text"
                                            class="form-control{{ $errors->has('emergency_contact_relationship') ? ' is-invalid' : '' }}"
                                            name="emergency_contact_relationship"
                                            value="{{ old('emergency_contact_relationship') }}"
                                            placeholder="Relationship" required>
                                        <small id="emergency_contact_relationshipError"
                                            style="visibility:hidden;color:red">Relationship is mandatory</small>
                                    ...
                                    <div class="col-sm-3">
                                        <label for="emergency_contact_phone">{{ __('Contact No. ') }}<span
                                                class="text-danger">*</span></label>
                                        <input id="emergency_contact_phone" type="text"
                                            class="form-control{{ $errors->has('emergency_contact_phone') ? ' is-invalid' : '' }}"
                                            name="emergency_contact_phone" value="{{ old('emergency_contact_phone') }}"
                                            placeholder="Telephone No." required>
                                        <small id="emergency_contact_phoneError"
                                            style="visibility:hidden;color:red">Contact No is mandatory</small>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <label for="emergency_contact_address">{{ __('Address ') }}<span
                                                class="text-danger">*</span></label>
                                        <input id="emergency_contact_address" type="text"
                                            class="form-control{{ $errors->has('emergency_contact_address') ? ' is-invalid' : '' }}"
                                            name="emergency_contact_address"
                                            value="{{ old('emergency_contact_address') }}" placeholder="Address"
                                            required>
                                        <small id="emergency_contact_addressError"
                                            style="visibility:hidden;color:red">Address is mandatory</small>
                            ...
                            <div class="col-md-12 pt-5 page-section" id="Passport-Details">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <label for="passport_number">{{ __('Passport Number ') }}<span
                                                class="text-danger">*</span></label>
                                        ...
                                        <small id="passport_numberError" style="visibility:hidden;color:red">Passport
                                            Number is mandatory</small>
                                    ...
                                    <div class="col-sm-6">
                                        <label for="passport_issue_place">{{ __('Passport Issue Place ') }}<span
                                                class="text-danger">*</span></label>
                                        <input id="passport_issue_place" type="text"
                                            class="form-control{{ $errors->has('passport_issue_place') ? ' is-invalid' : '' }}"
                                            name="passport_issue_place" value="{{ old('passport_issue_place') }}"
                                            placeholder="Passport Issue Place" required>
                                        <small id="passport_issue_placeError" style="visibility:hidden;color:red">Passport
                                            Issue Place is mandatory</small>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        <label for="passport_issue_date">{{ __('Passport Issue Date ') }}<span
                                                class="text-danger">*</span></label>
                                        <input id="passport_issue_date" type="date"
                                            class="form-control{{ $errors->has('passport_issue_date') ? ' is-invalid' : '' }}"
                                            name="passport_issue_date" min="1900-01-01" max="2200-01-01"
                                            value="{{ old('passport_issue_date') ? \Carbon\Carbon::parse(old('passport_issue_date'))->format('Y-m-d') : '' }}"
                                            placeholder="Passport Issue Date" required>
                                        <small id="passport_issue_dateError" style="visibility:hidden;color:red">Passport
                                            Issue Date is mandatory</small>
                                    ...
                                    <div class="col-sm-3">
                                        <label for="passport_expire_date">{{ __('Passport Expire Date ') }}<span
                                                class="text-danger">*</span></label>
                                        <input id="passport_expire_date" type="date"
                                            class="form-control{{ $errors->has('passport_expire_date') ? ' is-invalid' : '' }}"
                                            name="passport_expire_date" min="1900-01-01" max="2200-01-01"
                                            value="{{ old('passport_expire_date') ? \Carbon\Carbon::parse(old('passport_expire_date'))->format('Y-m-d') : '' }}"
                                            placeholder="Passport Expire Date" required>
                                        <small id="passport_expire_dateError" style="visibility:hidden;color:red">Passport
                                            Expire is mandatory</small>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="upload-area">
                                            <button type="button" class="upload-btn"><span
                                                    ng-bind="uploader.status.fileName">Choose File </span></button>
                                            <span class="uploadfiles">
                                                <input onchange="previewFile('#passport_file_preview','#passport_file')"
                                                    id="passport_file" type="file"
                                                    class="form-control-file{{ $errors->has('passport_file') ? ' is-invalid' : '' }}"
                                                    name="passport_file" value="{{ old('passport_file') }}"
                                                    placeholder="Passport File">
                                            </span>
                                            <p class="text-short-mes">Supported file format PDF. Maximum file size: 1MB</p>
                                            <img id="passport_file_preview" style="width: 100px;" src=""
                                                class="img-thumbnail" height="">
                                            <small id="passport_fileError" style="visibility:hidden;color:red">Passport
                                        ...
                                        <div class="upload-area">
                                            ...
                                            <span class="uploadfiles">
                                                <input
                                                    ...
                                                    class="form-control-file{{ $errors->has('medical_certificate') ? ' is-invalid' : '' }}"
                                                    name="medical_certificate" value="{{ old('medical_certificate') }}"
                                                    placeholder="Medical Certificate">
                                            </span>
                                            <p class="text-short-mes">Supported file format PDF. Maximum file size: 1MB</p>
                                            <img id="medical_certificate_preview" style="width: 100px;" src=""
                                                class="img-thumbnail" height="">
                                        ...
                                        <div class="upload-area">
                                            ...
                                            <span class="uploadfiles">
                                                <input
                                                    ...
                                                    id="immigration_security_clearence" type="file"
                                                    class="form-control-file{{ $errors->has('immigration_security_clearence') ? ' is-invalid' : '' }}"
                                                    name="immigration_security_clearence"
                                                    value="{{ old('immigration_security_clearence') }}"
                                                    placeholder="Immigration Security Clearence">
                                            </span>
                                            <p class="text-short-mes">Supported file format PDF. Maximum file size: 1MB</p>
                                            <img id="immigration_security_clearence_preview" style="width: 100px;"
                                ...
                                <div class="col-md-12 pt-5 page-section" id="Education">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <select name="education_level[]" id="id_1_education_level"
                                                class="form-control">
                                                <option value="">--Select Education Level--</option>
                                                @foreach ($education_levels as $education_level)
                                                    <option value="{{ $education_level->id }}"
                                                        {{ $education_level->id == (old('education_level')[0] ?? 'N/A') ? 'selected' : '' }}>
                                                        {{ $education_level->name ?? 'N/A' }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input id="id_1_education_remark" type="text" class="form-control"
                                                name="education_remark[]"
                                                value="{{ old('education_remark')[0] ?? 'N/A' }}"
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-6">
                                                    <div id="div_id_1_education_level" class="form-group dis-cls">
                                                        <label
                                                            for="id_1_education_level">{{ __('Education Level') }}</label>
                                                        <select name="education_level[]" id="id_1_education_level"
                                                            class="form-control">
                                                            <option value="">--Select Education Level--</option>
                                                            @foreach ($education_levels as $education_level)
                                                                <option value="{{ $education_level->id }}"
                                                                    {{ $education_level->id == old('education_level')[$i] ? 'selected' : '' }}>
                                                ...
                                                <div class="col-md-6">
                                                    <div id="div_id_1_education_remark" class="form-group dis-cls">
                                                        <label
                                                            for="id_1_education_remark">{{ __('Education Remark') }}</label>
                                                        <input id="id_1_education_remark" type="text"
                                                            class="form-control" name="education_remark[]"
                                                            value="{{ old('education_remark')[$i] }}"
                                                            placeholder="Education Remark">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
    ...
    @endforeach
                                ...
                                <div class="col-md-12 pt-5 page-section" id="Experience">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-3">
                                            ...
                                            <input id="id_1_employer_name" type="text" class="form-control"
                                                name="employer_name[]" placeholder="Employers Name"
                                                value="{{ old('employer_name')[0] ?? 'N/A' }}" required>
                                        </div>
                                        <div class="col-sm-3">
                                            ...
                                            <select name="country[]" id="id_1_employer_country" class="form-control">
                                                ...
                                                @foreach ($nationalitys as $nationality)
                                                    <option value="{{ $nationality->id }}"
                                                        {{ $nationality->id == (old('country')[0] ?? 'N/A') ? 'selected' : '' }}>
                                                        {{ $nationality->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input id="id_1_from_date" type="date" class="form-control"
                                                min="1900-01-01" max="2200-01-01"
                                                value="{{ old('from_date')[0] ?? 'N/A' }}" name="from_date[]">
                                        </div>
                                        <div class="col-md-3">
                                            <label for="id_1_to_date">{{ __('To Date') }}</label>
                                            <input id="id_1_to_date" type="date" class="form-control"
                                                min="1900-01-01" max="2200-01-01"
                                                value="{{ isset(old('to_date')[0]) ? \Carbon\Carbon::parse(old('to_date')[0])->format('Y-m-d') : 'N/A' }}"
                                                name="to_date[]" placeholder="N/A">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <input id="id_1_remark" type="text" class="form-control" name="remark[]"
                                                value="{{ old('remark')[0] ?? 'N/A' }}" placeholder="Remark">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <hr class="mt-4 mb-4" />
                                        ...
                                        @for ($i = 1; $i < count(old('employer_name')); $i++)
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <input id="id_1_employer_name" type="text" class="form-control"
                                                        name="employer_name[]" placeholder="Employers Name"
                                                        value="{{ old('employer_name')[$i] }}" required>

                                                </div>
                                                <div class="col-md-6">
                                                    <div id="div_id_1_employer_country" class="form-group dis-cls">
                                                        <label
                                                            for="id_1_employer_country">{{ __('Employer Country') }}</label>
                                                        <select name="country[]" id="id_1_employer_country"
                                                            class="form-control">
                                                            <option value="">--Select Country--</option>
                                                            @foreach ($nationalitys as $nationality)
                                                                <option value="{{ $nationality->id }}"
                                                                    {{ $nationality->id == old('country')[$i] ? 'selected' : '' }}>
                                                                    {{ $nationality->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div id="div_id_1_from_date" class="form-group dis-cls">
                                                        ...
                                                        <input id="id_1_from_date" type="date" class="form-control"
                                                            min="1900-01-01" max="2200-01-01"
                                                            value="{{ old('from_date')[$i] ? \Carbon\Carbon::parse(old('from_date')[$i])->format('Y-m-d') : '' }}"
                                                            name="from_date[]">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div id="div_id_1_to_date" class="form-group dis-cls">
                                                        ...
                                                        <input id="id_1_to_date" type="date" class="form-control"
                                                            min="1900-01-01" max="2200-01-01"
                                                            value="{{ old('to_date')[$i] ? \Carbon\Carbon::parse(old('to_date')[$i])->format('Y-m-d') : '' }}"
                                                            name="to_date[]">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div id="div_id_1_remark" class="form-group dis-cls">
                                                        <label for="id_1_remark">{{ __('Remark') }}</label>
                                                        <input id="id_1_remark" type="text" class="form-control"
                                                            name="remark[]" value="{{ old('remark')[$i] }}"
                                                            placeholder="Remark">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                            ...
                                            <div class="recordset">
                                                <div class="fieldRow clearfix">
                                                    <div class="form-group row">
                                                        <div class="col-sm-3">
                                                            <label
                                                                for="id_1_employer_name">{{ __('Employer Name') }}</label>
                                                            <input id="id_1_employer_name" type="text"
                                                                class="form-control" name="employer_name[]"
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input id="id_1_from_date" type="date"
                                                                class="form-control" min="1900-01-01" max="2200-01-01"
                                                                value="{{ isset(old('from_date')[0]) ? \Carbon\Carbon::parse(old('to_date')[0])->format('Y-m-d') : 'N/A' }}"
                                                                name="from_date[]">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-12">
                                                            <label for="id_1_remark">{{ __('Remark') }}</label>
                                                            <input id="id_1_remark" type="text" class="form-control"
                                                                name="remark[]" value="{{ old('remark')[0] ?? 'N/A' }}"
                                                                placeholder="Remark">
                                                        </div>
                                                    </div>
                                                    <!-- <div class="col-md-12">
                                ...
                                <div class="col-md-12 pt-5 page-section nonflex-cls" id="Skills">
                                    <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group dis-cls" style="display:flex;">
                                                        ...
                                                        <input style="height:30px;width:30px;" type="checkbox"
                                                            id="" name="{{ $skill->slug }}"
                                                            {{ $checked }} value="Yes">
                                                        <label style="padding-top: 3px;padding-left: 5px;"
                                                            for="able_to_cook">{{ $skill->name }}</label>
                                                    </div>
                                                </div>
                                            @endif
                                        @endforeach
                                        <div class="col-md-12">
                                            <div class="form-group dis-cls">
                                                <label
                                                    for="other_skills">{{ __('Other Skills (Seperate with Comma)') }}</label>
                                                <input id="other_skills" type="text"
                                                    class="form-control{{ $errors->has('other_skills') ? ' is-invalid' : '' }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group dis-cls" style="display:flex;">
                                                    @php
                                                        $checked = old($skill->slug) ? 'checked' : '';
                                                    @endphp
                                                    <input style="height:30px;width:30px;" type="checkbox" id=""
                                                        name="{{ $skill->slug }}" {{ $checked }} value="Yes">
                                                    <label style="padding-top: 3px;padding-left: 5px;text-align: left;"
                                                        for="able_to_cook">{{ $skill->name }}</label>
                                                </div>
                                            </div>
                                        @endif
                    ...
                    <div style="overflow:auto;">
                        <div style="float:right;">
                            <button class="prev-btn" type="button" id="prevBtn"
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function nextPrev(n) {
            ...
            const emergency_contact_relationshipValue = document.getElementById('emergency_contact_relationship').value
                .trim();
            ...
            const immigration_security_clearenceValue = document.getElementById('immigration_security_clearence').value
                .trim();
            ...
            var medical_certificate_file_ext = medical_certificateValue.substring(medical_certificateValue.lastIndexOf(
                '.') + 1);
            var immigration_security_clearence_file_ext = immigration_security_clearenceValue.substring(
                immigration_security_clearenceValue.lastIndexOf('.') + 1);
        ...
        (function($, undefined) {
            $.fn.czMore = function(options) {
                ...
                return this.each(function() {
                    ...
                    var count = '<input id="' + this.id + '_czMore_txtCount" name="' + this.id +
                    ...
                    function resetNumbering() {
                        $(obj).children(".recordset").each(function(index, element) {
                            $(element).find(
                                ...
                                .each(function() {
                                    old_name = this.name;
                                    new_name = old_name.replace(/\_([0-9]\d{0})\_/g, "_" + (
                                        index + 1) + "_");
                    ...
                    function minusClick(recordset) {
                        $(recordset).children("#btnMinus").click(function() {
                            ...
                            $(recordset).remove();
                            resetNumbering();
                            obj.siblings("input[name$='czMore_txtCount']").val(obj.children(
                                ".recordset").length);
                            i--;
        ...
        $('#sector').on('change', function() {
            ...
            $.ajax({
                ...
                success: data => {
                    ...
                    if (x.length < 1) {
                        $('#sub_sector').append(
                            '<option value="">--No Sub Sector for this sector--</option>')
                    } else {
                        $('#sub_sector').append('<option value="">--Select Sub Sector--</option>');
                    }

                    data.sub_sectors.forEach(sub_sector =>
                        $('#sub_sector').append('<option value="' + sub_sector.id + '">' +
...
{{-- <script>
    $(document).ready(function () {
        ...
        $('#company_country2').change(function () {
            let countryId = $(this).val();
            // let countryName = $('#company_contry option:selected').text();

            // console.log(countryName);
            let stateDropdown = $('#company_state2');
            let cityDropdown = $('#company_city2');
        ...
        $('#company_state2').change(function () {
...
<script>
    $(document).ready(function () {
        // Retrieve old values for state and city from Laravel's `old()`
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.length > 0) {
                                ...
                                // Preselect the old state value if it exists
                                if (oldStateValue) {
                                    stateDropdown.val(oldStateValue).change();
                                }
                            } else {
                                stateDropdown.append('<option value="" disable="true">No states found</option>');
                            }
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.length > 0) {
                                ...
                                // Preselect the old city value if it exists
                                if (oldCityValue) {
                                    cityDropdown.val(oldCityValue);
                                }
                            } else {
                                cityDropdown.append('<option value="" disable="true">No cities found</option>');
                            }
                        ...
                        error: function (jqXHR, textStatus, errorThrown) {
                            console.error('Error fetching cities:', textStatus, errorThrown);
                            alert('Failed to fetch city. No cities are available for this state. Please try again later.');
                        },
                    });
                } catch (error) {
                    console.error('AJAX error', error);
        ...
        // Trigger country change on page load to preselect old state and city
        let oldCountryValue = "{{ old('company_country') }}";
        if (oldCountryValue) {
            $('#company_country2').val(oldCountryValue).change();
        }
    });
</script>
