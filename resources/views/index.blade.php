  ...
  @section('content')
              ...
              <div class="carousel-inner" role="listbox">
                  ...
                  <div class="carousel-item active" style="background-image: url({{ asset('site/img/slide/1.jpg') }});">
                      <div class="carousel-container row align-items-center">
                          ...
                          <div
                              class="carousel-content animate__animated animate__fadeInUp justify-content-end col-sm-6 mb-0">
                              <h2 style="text-align: center;">Recents Jobs <br> For Local & Overseas</h2>
                              <p>
                              <table class="table-responsive" border="1" cellpadding="2" cellspacing="0"
                                  style="border-collapse: collapse;">
                                  <thead>
                                      <tr>
                                          <th class="px-2">Job ID</th>
                                  ...
                                  <tbody>
                                      @forelse ($recent_jobs as $item)
                                          <tr>
                                              <td class="px-2">{{ $item->j_id ?? 'N/A' }}</td>
                                              <td class="px-2">{{ $item->company_name ?? 'N/A' }}</td>
                                              <td class="px-2">{{ $item->option_name ?? 'N/A' }}</td>
                                              <td class="px-2">{{ $item->total_number_of_vacancies ?? 'N/A' }}</td>
                                              <td class="px-2">{{ $item->state_name ?? 'N/A' }}</td>
                                              <td class="px-2">{{ $item->country_name ?? 'N/A' }}</td>
                                              <td class="px-2">
                                                  <strong><a
                                                          href="{{ route('recent.job.details', ['id' => $item->j_id]) }}">View
                                                          Job</a></strong>
                                              </td>
                                          </tr>
                                      @empty
                                          <tr>
                                              <td colspan="7">No recent jobs available.</td>
                                          </tr>
                                      @endforelse
                  ...
                  {{-- <div class="carousel-item "
                      style="background-image: url({{ asset('site/img/slide/6.jpeg') }}); border:solid 5px lightblue">
                      <div class="carousel-container row align-items-center">
                         
                          <div class="carousel-content animate__animated animate__fadeInUp justify-content-center">
                              <h2 style="text-align: center; margin-top:0px;margin-top:0px;">Recents Jobs <br> For Local &
                                  Overseas</h2>
                              <img src="{{ asset('site/img/slide/flagwhite.png') }}" class="img-fluid"
                  ...
                  <div class="carousel-item" style="background-image: url({{ asset('site/img/slide/2.jpg') }});">
                      <div class="carousel-container row align-items-center">
                          <div class="carousel-content animate__animated animate__fadeInUp">
                              ...
                              <p>The global landscape rapidly changes the needs and dynamics of the market. Online Jobs
                                  remains to be your greatest ally and partner.
                  ...
                  <div class="carousel-item" style="background-image: url({{ asset('site/img/slide/3.jpg') }});">
                      <div class="carousel-container row align-items-center">
                          <div class="carousel-content animate__animated animate__fadeInUp">
                              ...
                              <p> <strong>Looking for your next career breakthrough?</strong> Allow us to know you better
                                  through a personal consultation.Together, we'll pave the way to your professional success.
                              </p>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="carousel-item" style="background-image: url({{ asset('site/img/slide/4.jpg') }});">
                      <div class="carousel-container row align-items-center">
                          <div class="carousel-content animate__animated animate__fadeInUp">
                              ...
                              <p>Let Ap Online Jobs Be Your Trust Placement Agency where we handle the challenges while you
                                  focus on success. Let us take care of your hard works, ensuring smooth and efficient
                                  results.</p>
                      ...
                      <div class="col-lg-12">
                          <div class="row">
                              ...
                              <div class="form-group col-lg-4 col-md-3 col-sm-12 p-0">
                                  <input type="text" id="position_name_jobs" name="position_name_jobs"
                                      class="form-control wrn-btn" placeholder="Job Tittle or keyword">
                              </div>
                              <div class="form-group col-lg-4 col-md-3 col-sm-12 p-0">
                                  <input type="text" name="location_name" class="form-control wrn-btn"
      ...
      <main id="main">
          ...
          <section id="about-us" class="who-we-are">
              <div class="container" data-aos="zoom-in-right">
                  <div class="row content">
                      ...
                      <div class="col-lg-7" data-aos="zoom-in-right">
                          <img src="{{ asset('site/img/about/who-we-are1.jpeg') }}" class="mx-auto d-block"
                              alt="..." width="650px" height="440px"
              ...
              border-radius: 10px 50px 5px; ">
                      ...
                      <div class="col-lg-5 texts" data-aos="fade-left">
                          <p>
                              AP Online Jobs is a global online employment solution for people seeking job with great
                              career, and for
                              the employers who need talented and skill personals. AP Online Jobs have been serving the
                              human
                              resources
                              industries for more than 18 years.
                          </p>
                          <p>
                              We assist employers not only to find the best quality candidates, but the entire streamline
                              process so
                              that you can save time and money. This will aid your decision making process further improving
                              your
                              Return
                              of Investment (ROI). In short AP Online will be your channel to hire most suitable candidate
                              like never
                              before .
                          </p>
              ...
              <div class="container" data-aos="fade-up">
                  <div class="row content">
                      ...
                      <div class="col-lg-5 texts" data-aos="fade-left">
                          <br>
                          <p>
                              At AP Online Jobs, we strive to bring values and fulfilling opportunities and the needs to the
                              job
                              market,
                              with add on value to lives, businesses and communities around the world.
                          </p>
                          <p>
                              We create and deliver the best recruiting solution through various platforms, may it be
                              online, as well
                              as
                              direct networking to connect employer and job seekers ; we strive every day to help our
                              employing
                              clients
                      ...
                      <div class="col-lg-7" data-aos="fade-right">
                          <img src="{{ asset('site/img/about/what-we-do.jpg') }}" class=" mx-auto d-block"
                              alt="" width="650px" height="440px">
                      </div>
              ...
              <div class="container">
                  ...
                  <div class="row portfolio-container aos-init aos-animate" data-aos="fade-up"
                      ...
                      <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                          <img src="{{ asset('site/img/services/client-services.jpeg') }}" class="img-fluid"
                              alt="">
                          <div class="portfolio-info">
                              <h4>Client Services</h4>
                              <a href="{{ asset('site/img/services/client-services.jpeg') }}"
                      ...
                      <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                          <img src="{{ asset('site/img/services/fwms-digital-platform.jpeg') }}" class="img-fluid"
                              alt="">
                          <div class="portfolio-info">
                              <h4>Fwwmc Digital Platform</h4>
                              <a href="{{ asset('site/img/services/fwms-digital-platform.jpeg') }}"
                                  data-gallery="portfolioGallery" class="portfolio-lightbox preview-link"
                                  title="
                    ...
                    in Malaysian.">
                      ...
                      <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                          <img src="{{ asset('site/img/services/contract-managed-services.jpeg') }}" class="img-fluid"
                              alt="">
                          <div class="portfolio-info">
                              <h4>Contract Managed Services</h4>
                              <a href="{{ asset('site/img/services/contract-managed-services.jpeg') }}"
                                  data-gallery="portfolioGallery" class="portfolio-lightbox preview-link"
                      ...
                      <div class="col-lg-4 col-md-6 portfolio-item filter-app"
                          ...
                          <img src="{{ asset('site/img/services/handyman.jpeg') }} " class="" alt=""
                              height="280px !important" width="417px">
                          <div class="portfolio-info">
                              <h4>Handyman Service</h4>

                              <a href="{{ asset('site/img/services/handyman.jpeg') }}" data-gallery="portfolioGallery"
                                  class="portfolio-lightbox preview-link" title="portfolio-lightbox preview-link"
                                  title="
                  If you’re looking to book the best handyman service to help you out around
                    the house, look no further than Handy."><i
                      ...
                      <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                          <img src="{{ asset('site/img/services/recruitment-services.jpeg') }}" class="img-fluid"
                              alt="">
                          <div class="portfolio-info">
                              <h4>Recruitment Services</h4>
                              <a href="{{ asset('site/img/services/recruitment-services.jpeg') }}"
                                  data-gallery="portfolioGallery" class="portfolio-lightbox preview-link"
                                  title="portfolio-lightbox preview-link"
                                  title="
                ...
                We have an extensive global network of personal contacts gained over many years."><i
                      ...
                      <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                          <img src="{{ asset('site/img/services/managed-services-provider.jpeg') }}" class="img-fluid"
                              alt="">
                          <div class="portfolio-info">
                              <h4>Managed Services Provider </h4>
                              <a href="{{ asset('site/img/services/managed-services-provider.jpeg') }}"
                                  data-gallery="portfolioGallery" class="portfolio-lightbox preview-link"
          ...
          <!-- ======= Partners ======= -->
          <section
              style="background-image: url('{{ asset('site/img/building-landscape-with-blue-overlay.jpg') }}') !important;">
              <div class="carousel-wrap carousels">
                  ...
                  <div class="owl-carousel" data-aos="fade-up" data-aos-anchor-placement="top-center">
                      <div class="item"><img src="{{ asset('site/img/overseas-partners/overseas_bangladesh.jpg') }}">
                      </div>
                      <div class="item"><img src="{{ asset('site/img/overseas-partners/overseas_hongkong.jpg') }}">
                      </div>
                      <div class="item"><img src="{{ asset('site/img/overseas-partners/overseas_indonesia.jpg') }}">
                      </div>
                      ...
                      <div class="item"><img
                              src="{{ asset('site/img/overseas-partners/overseas_unitedkingdom.jpg') }}"></div>
          ...
          <section id="clients" class="clients">
              <div class="container" data-aos="fade-up">
                  ...
                  <div class="row no-gutters clients-wrap clearfix" data-aos="fade-up">
                      ...
                      <div class="col-lg-3 col-md-4 col-6">
                          <div class="client-logo">
                              <img src="{{ asset('site/img/clients/swm-enviroment.png') }}" class="img-fluid"
                                  alt="">
                          </div>
                      </div>
                      ...
                      <div class="col-lg-3 col-md-4 col-6">
                          <div class="client-logo">
                              <img src="{{ asset('site/img/clients/tradewinds.png') }}" class="img-fluid"
                                  alt="">
                          </div>
                      </div>
