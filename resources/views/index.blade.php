      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url({{asset('site/img/slide/1.jpg')}});">
          <div class="carousel-container row align-items-center">
            ...
            <div class="carousel-content animate__animated animate__fadeInUp justify-content-end col-sm-6 mb-0">
              <h2 style="text-align: center;">Recents Jobs <br> For Local & Overseas</h2>
              <p>
                <table class="table-responsive"  border="1" cellpadding="2" cellspacing="0" style="border-collapse: collapse;">
                  <thead>
                      <tr>
                  ...
                  <tbody>
                    ...
                    @forelse ($recent_jobs as $item)
                          <tr>
                              ...
                              <td class="px-2">
                                  {{-- <strong><a href="{{ route('recent.job', ['id' => $item->j_id]) }}">View Jobs</a></strong> --}}
                                  <strong><a href="{{ route('recent.job.details', ['id' => $item->j_id]) }}">View Job</a></strong>
                                  {{-- <strong><a href="/login">Login To View</a></strong> --}}
                              </td>
                          </tr>
                      @empty
                          <tr>
        ...
        <!-- Slide 5 -->
        <div class="carousel-item " style="background-image: url({{asset('site/img/slide/6.jpeg')}}); border:solid 5px lightblue">
          <div class="carousel-container row align-items-center">
            {{-- <div class="carousel-content animate__animated animate__fadeInUp col-sm-4">
              <h2 style="text-align: center;">Your search for a career begins here <br> For Local & Overseas</h2>
              <p>Wherever you go, Go with all your heart with enthusiasm, passionate and  responsibility.</p>
            </div>
            <div class="col-sm-2"></div> --}}
            <div class="carousel-content animate__animated animate__fadeInUp justify-content-center" >
              <h2 style="text-align: center; margin-top:0px;margin-top:0px;">Recents Jobs <br> For Local & Overseas</h2>
              <img src="{{ asset('site/img/slide/flagwhite.png') }}" class="img-fluid" alt="Responsive image" style="width: 100%">
        ...
        <div class="carousel-item" style="background-image: url({{asset('site/img/slide/3.jpg')}});">
          <div class="carousel-container row align-items-center">
            <div class="carousel-content animate__animated animate__fadeInUp">
              ...
              <p> <strong>Looking for your next career breakthrough?</strong> Allow us to know you better through a personal consultation.Together, we'll pave the way to your professional success.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="carousel-item" style="background-image: url({{asset('site/img/slide/4.jpg')}});">
          <div class="carousel-container row align-items-center">
            <div class="carousel-content animate__animated animate__fadeInUp">
              ...
              <p>Let Ap Online Jobs Be Your Trust Placement Agency where we handle the challenges while you focus on success. Let us take care of your hard works, ensuring smooth and efficient results.</p>
